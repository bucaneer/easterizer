...
import { dateToJulianDay } from './julian.js'
import { getDateFromJulianDay } from './seasons.js';
...
function truephase (k, tphase) {
  ...
  return getDateFromJulianDay(pt)
}
...
export {
    ...
    LAST as PHASE_LAST,
    phase,
    phaseHunt as phase_hunt,
    phaseRange as phase_range,
}
